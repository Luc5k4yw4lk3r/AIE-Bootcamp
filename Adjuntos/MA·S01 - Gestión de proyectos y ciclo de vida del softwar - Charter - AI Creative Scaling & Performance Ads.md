...
- **Estrategia comercial profunda:** Pomelli no define tu modelo de negocio, no elige a tu público objetivo (_Buyer Persona_) ni establece tus estrategias de precios. Solo ejecuta y diseña en base a la información que tú le proporcionas.
- **Gestión de presupuestos publicitarios (Media Buying):** Aunque la herramienta puede crear las imágenes y los textos persuasivos para tus campañas, no administra tu dinero. La configuración técnica de las campañas, la optimización de pujas y el análisis de métricas de rendimiento en plataformas como Google Ads o Meta Ads quedan bajo tu responsabilidad.
### Interacción y gestión en vivo
- **Community Management y atención al cliente:** La IA genera los borradores de las publicaciones, pero no interactúa con tu audiencia. No responde mensajes directos, no modera comentarios ni resuelve quejas de los usuarios.
- **Gestión de crisis:** Si tu marca enfrenta un problema de reputación en línea, Pomelli no tiene la capacidad de entender el contexto social para redactar comunicados de contingencia o cambiar el tono de voz de manera empática; eso requiere criterio puramente humano.
### Formatos complejos y legalidad
- **Producción de video avanzado:** Su punto fuerte actual es la generación de texto, la edición de fotografía de producto (imágenes estáticas) y el diseño visual de páginas web. La creación, edición o generación de video complejo con narrativa no es parte de su núcleo operativo.
...
- **Brand Books (Manuales de Marca):** Permite a los negocios crear guías estructuradas que definen cómo debe verse y comunicarse la marca, algo que generalmente solo tienen las empresas grandes.

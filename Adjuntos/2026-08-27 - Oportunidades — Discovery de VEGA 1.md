...
**Outcome de referencia:** Bajar el tiempo medio de resolución de los contactos entrantes de "no entiendo mi factura" en el primer contacto[cite: 1].
**Equipo:** [Tu Equipo] · **Fecha:** 25 de agosto de 2026

## Artefactos visuales (Excalidraw)
...
*(Injerencias derivadas del Journey Map para entrevistar a los stakeholders y agentes)*[cite: 1]
